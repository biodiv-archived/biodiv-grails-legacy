...
def s = ctx.getBean("mailService");

//def body=g.render(view:"/emailtemplates/welcomeEmail");

s.sendMail {
	to "pearlsravanthi@gmail.com"
	from "sravanthi@strandls.com"
	subject "test"
	body(view:"/emailtemplates/welcomeEmail")
}
