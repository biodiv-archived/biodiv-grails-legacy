...
class TraitController extends AbstractObjectController {
    ...
    def edit() {
        ...
        if (!traitInstance) {
            ...
            render(view: "create", model: [traitInstance: traitInstance  , traitValues:TraitValue.findAllByTraitInstance(traitInstance), userLanguage:userLanguage,field: field.concept+'|'+field.category])
        }
        return;
    }
