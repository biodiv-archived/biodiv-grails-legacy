...
def test(){
          ...
          List<String> list=["33707","33485","14722", "329553","230495"] ;
    ...
    list.add(346624)
    list.add(361121)*/
    //list.add(309533)//1 observation from checklist
    //list.add(268646)//14 imges
   //list.add(33485)//video
   // list.add(256470)//11 image +audio
   // list.add(239414)
   // list.add(385506)
    //list.add(385932)
...
def it_species =Species.read(it)
 def it_next= it_species as JSON ; 
...
def it_final=JSON.parse(""+it_next)
 ...
 list_final.add(it_final)
        ...
        String reqUser ="reqUser"
        String dl_id ="dl_id"
        String params_filterUrl ="params_filterUrl"


        String directory = "/home/ifp/ObservationDataDir";
        println "==========================================";


        println "****************************************";

       DwCSpeciesExporter.getInstance().exportSpecieData(directory, list_final, reqUser, dl_id, params_filterUrl);

   
        println "*************************endofcompilation_specie*******";
...
def test2(){
   ...
   List<String> list=[] ;
    ...
    list.add(361121)*/
    list.add(309533)//1 observation from checklist
    list.add(384717)//14 imges
    list.add(346706)//video
    list.add(384718)//11 image +audio
    //list.add(385933)
    //list.add(385506)
    //list.add(385932)
    ...
    //obvUtilService.exportAsKML(directory, list_final, reqUser, dl_id , params_filterUrl)//works
      //obvUtilService.exportAsDW(directory, list, reqUser, dl_id, params_filterUrl)//works with specie and observtion
       obvUtilService.exportAsCSV(directory, list, reqUser, dl_id , params_filterUrl)//works
        println "*************************fincompilationetcreationobjet***directory*******";


render "C qui le plus beau !!!!!!!!!  ";
