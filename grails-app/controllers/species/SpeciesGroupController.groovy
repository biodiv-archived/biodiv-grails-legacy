...
class SpeciesGroupController {
    ...
    def list = {
		params.id = SpeciesGroup.findByName("All").id
        ...
        if (speciesGroupInstance) {
            if (params.version) {
                ...
                if (speciesGroupInstance.version > version) {
                    ...
                    speciesGroupInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'speciesGroup.label', default: 'SpeciesGroup')] as Object[], "Another user has updated this SpeciesGroup while you were editing")
