...
//        return commitDocs(docs, commit);
  ...
  GROUP BY obs.id, su.name, su.icon, su.profile_pic, sg.name, h.name, ll.name, l.name, r.name, t.canonical_form, r.taxon_concept_id, r.accepted_name_id, tres.path, tres.classification_id, t.status, t."position", t.rank, resp.file_name """;
