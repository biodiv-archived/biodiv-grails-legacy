                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="author"><g:message code="name.author.label" default="Author" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: nameInstance, field: 'author', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="year"><g:message code="name.year.label" default="Year" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: nameInstance, field: 'year', 'errors')}">
