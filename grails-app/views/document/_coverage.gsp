<div class="span12 super-section" style="clear: both; margin-left:0px;">
	...
	<hr>
	<obv:showMapInput model="[observationInstance:coverageInstance, obvInfoFeeder:coverageInstance, locationHeading:'Geographical Coverage', 'sourceInstance':sourceInstance, webaddress:params.webaddress]"></obv:showMapInput>
</div>
