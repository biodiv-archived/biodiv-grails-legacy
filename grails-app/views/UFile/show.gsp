            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="UFile.description.label" default="Description" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: UFileInstance, field: "description")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="UFile.dateCreated.label" default="Date Created" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${UFileInstance?.dateCreated}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="UFile.doi.label" default="Doi" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: UFileInstance, field: "doi")}</td>
