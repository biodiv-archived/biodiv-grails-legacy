...
<div style="clear:both;border-style:groove;border-width:6px;color:green;border-radius:10px;height:645px;">
	...
	<div id="annotatedtimeline_activity" style='width: 905px; height: 180px;'></div>
	...
	<div style="clear:both;">
			<div>			
				<gvisualization:table dynamicLoading="${true}" elementId="table_user" width="${420}" height="${405}"
					columns="${userData.htmlColumns}" data="${userData.htmlData}" allowHtml="${true}" />
				<div id="table_user" style="float: left;"></div>
			</div>
			
			<div>			
				<gvisualization:table dynamicLoading="${true}"  elementId="table_all" width="${525}" height="${405}"
