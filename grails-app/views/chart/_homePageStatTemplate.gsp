...
<div style="clear:both;border-style:groove;border-width:6px;color:green;border-radius:10px;">
	...
	<gvisualization:annotatedTimeLine  dynamicLoading="${true}"  elementId="annotatedtimeline_activity" columns="${activityData.columns}" data="${activityData.data}" max="${max?:500}" fill="${30}" displayRangeSelector="${false}"  zoomStartTime="${(new Date())-5}"/>
<%----%>
<%--	<br/>--%>
