...
<body>
	...
	<div class="span12">
		...
		<br>
		<chart:showStats model="['title':'User Stats (Last 7 days) ', columns:userData.columns, data:userData.data, hAxisTitle:'User', htmlData:userData.htmlData]"/>
		
		<chart:showStats model="['title':'Observations', columns:obvData.columns, data:obvData.data]"/>
		
		<chart:showStats model="['title':'Species', columns:speciesData.columns, data:speciesData.data]"/>
	</div>
	<r:script>
	</r:script>
</body>
