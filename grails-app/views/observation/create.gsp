...
<body>
		...
		<div class="observation grid_16 big_wrapper">
			...
			<div class="dialog">
				<table>
					<tbody>
						<tr class="prop">
							<th valign="top"><h3>Add multimedia</h3>
							</th>
							<td>
								<form id="upload_resource" enctype="multipart/form-data">
									...
									<input type="file" id="attachFiles" name="resources"
										multiple="multiple" accept="image/*" /> <span class="msg"></span>
								</form></td>
						</tr>
					</tbody>
				</table>
							...
							<g:each in="${observationInstance?.resource}" var="r">
								<li class="addedResource grid_15">
									...
									<div class='metadata prop'>
										...
										<div class="rating">
											<input class="star" type="radio" name="rrating.${i}"
												value="1" title="Worst" /> <input class="star" type="radio"
								...
								<tr class="prop">
									...
									<td valign="top"
										...
										<g:datePicker name="observedOn" precision="day"
											...
											class="ui-widget-content ui-corner-all" /></td>
								</tr>
								...
								<tr class="prop">
									...
									<td valign="top">
										<div id="location_picker">
											...
											<div id="result_box">
												<div class="row">
													<span class="label">Place name:</span> <input
														id="place_name" type="text" name="place_name"></input>
												</div>
												<!--div class="row">
	...
	<li class="addedResource grid_15">
		...
		<div class='metadata prop'>
			...
			<label class="name grid_2">Title </label><input name="title_{{=i}}" type="text" size='50' class='value ui-corner-all' value='{{=title}}'/><br/>
