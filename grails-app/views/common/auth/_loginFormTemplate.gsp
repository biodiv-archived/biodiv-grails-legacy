	...
	<fieldset>
		...
		<form action='${daoPostUrl}' method='POST' class="form-horizontal"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-xlarge focused username" type="text" name="j_username" id="username"
			...
			<div class="control-group" style="clear: both;">
				...
				<div class="controls">
					<input class="input-xlarge password" type="password" id="password" name="j_password"
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="checkbox"> <input type="checkbox"
						name="${rememberMeParameter}" for="remember_me" class="remember_me" id="remember_me"/> <g:message
						...
						</a> </label> <input class="btn btn-primary" type="submit" id="login" value="${g.message(code:'button.login')}"
