...
<ul class="nav left-sidebar">
	...
	<li class="dropdown"><a href="#" class="dropdown-toggle"
		data-toggle="dropdown"> Home<b class="caret"
			...
			<sec:ifLoggedIn>
				...
				<li><a
					...
					title="Groups is in Beta. We would like you to provide valuable feedback, suggestions and interest in using the groups functionality."><i
						class="icon-user"></i>My Groups<sup>Beta</sup>
				</a> <uGroup:getCurrentUserUserGroupsSidebar /></li>
			</sec:ifLoggedIn>
		...
		<ul class="dropdown-menu">
			<li><a
				href="${uGroup.createLink(controller:'userGroup', absolute:'true', action:'list')}">
					<i class="icon-user"></i>All Groups<sup>Beta</sup> </a>
			</li>
			<li><uGroup:showSuggestedUserGroups />
			</li>
		</ul>
	<li>
</ul>
