				...
				<div class="users">
					<g:if test="${!hideAgree}">
						<div class="iAgree ">
							...
							<g:else>
								<button class="btn btn-primary btn-small" onclick="removeRecoVote(${r.obvId}, ${r.recoId}, '${uGroup.createLink(controller:'observation', action:'removeRecommendationVote')}'); return true;">Remove</button>
							</g:else>	
						</div>
					</g:if>
