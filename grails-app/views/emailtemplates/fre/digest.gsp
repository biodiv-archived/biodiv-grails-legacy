...
<html><head><title>d'activité</title>
    ...
    <body>
        <table style="width:621px; border:1px solid #a1a376;">
            <tr>
                <td id="header" class="w640" align="left" bgcolor="#ffffff"><a href="${serverURL}/"><img src="${assetPath(src:'/all/'+'whatsnewbanner_3.gif',absolute:'true' )}" alt="${siteName}" style="border: 0px solid ;width: 627px; height: 53px;"></a></td>
            </tr>
            <tr>
