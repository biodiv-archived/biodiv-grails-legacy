<div class="tabbable speciesFieldImage-wrapper " style="">
    <ul class="nav nav-tabs" id="speciesFieldImage-tabs" style="margin:0px;background-color:transparent;">
        <g:if test="${isSpeciesContributor}">
            <li id="speciesFieldImage-li0" class="active"><a href="#speciesFieldImage-tab0" class="btn" data-toggle="tab">Add Observation Media</a></li>
            <li id="speciesFieldImage-li1"><a href="#speciesFieldImage-tab1" class="btn" data-toggle="tab">Upload/Edit Media</a></li>
        </g:if>
    </ul>
