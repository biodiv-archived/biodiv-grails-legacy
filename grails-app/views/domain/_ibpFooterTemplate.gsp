	...
	<div class="container outer-wrapper">
		<div class="links_box_column">
			<ul>
				...
				<li><a href='/about/what-are-biodiversity-hotspots'>What
						are Biodiversity Hotspots?</a></li>
		...
		<div class="links_box_column">
			<ul>
				...
				<li><a href='/people/working_group'>Working Group</a></li>
				<li><a href='/people/team'>Team</a></li>
				<li><a href='/people/volunteers'>Volunteers</a></li>
			</ul>
		</div>
		...
		<div class="links_box_column">
			<ul>
				...
				<li><a href='/policy/participation'>Participation</a>
				</li>
				<li><a href='/policy/data_sharing'>Data Sharing</a>
				</li>
				<li><a href='/policy/platform'>Platform</a>
				</li>
		...
		<div class="links_box_column">
			<ul>
				<li class="nav-header bold"><a href='/help'>Others</a>
				</li>
