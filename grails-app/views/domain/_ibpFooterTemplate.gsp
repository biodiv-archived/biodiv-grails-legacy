...
<div id="ibp-footer" class="gradient-bg-reverse navbar">
	<div class="container outer-wrapper">
		<div class="links_box_column">
			<ul>
				...
				<li
					...
					href="/map" title="Maps">All Maps</a>
				</li>
				<li
					class="nav-header bold ${(request.getHeader('referer')?.contains('/browsechecklists'))?' active':''}"><a
					href="/browsechecklists" title="Checklists">All Checklists</a>
				</li>
				<li
		...
		<div class="links_box_column">
			<ul>
				<li class="nav-header bold"><a href='/about'>About</a>
				</li>
				<li><a href='/biodiversity_in_india'>Biodiversity in India</a>
				</li>
				<li><a href='/about/whats-new'>What's new?</a>
				</li>
				<li><a href='/about/technology'>Technology</a>
				</li>
				<li><a href='/help/faqs'>FAQ</a>
				</li>
		...
		<div class="links_box_column">
			<ul>
				<li class="nav-header bold"><a href='/people'>People</a>
				</li>
				<li><a href='/people/partners'>Partners</a>
				</li>
				<li><a href='/people/donors'>Donors</a>
				</li>
				<li><a href='/people/team'>Team</a>
				</li>
			</ul>
		</div>
		...
		<div class="links_box_column">
			<ul>
				<li class="nav-header bold"><a href='/policy'>Policy</a></li>
				<li><a href='/policy/data_sharing'>Data Sharing</a></li>
		...
		<div class="links_box_column">
			<ul>
				...
				<li><a href='/feedback_form'>Feedback</a></li>
...
<li><a href='/about/what-are-biodiversity-hotspots'>What
						are Biodiversity Hotspots?</a>
				</li>
				<li><a href='/about/portal-objectives'>Portal Objectives</a>
				</li>
				<li><a href='/about/data-sharing-guidelines'>Data Sharing
						Guidelines</a>
				</li>
				<li><a href='/about/participation-and-action'>Participation
						and Action</a>
				</li>
				<li><a href='/about/roadmap1'>Roadmap</a>
				</li>
