            ...
            <ul class="dropdown-menu mega-menu">
              <li class="mega-menu-column">
                <ul>
                  ...
                  <li><a href="${uGroup.createLink('controller':'dataTable', action:'list', params:['type':'observations', 'isChecklist':true], 'userGroup':userGroupInstance)}" title="${g.message(code:'heading.browse.checklists')}"><g:message code="heading.browse.checklists" /></a></li>
