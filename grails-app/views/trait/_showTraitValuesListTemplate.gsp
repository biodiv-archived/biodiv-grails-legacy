<div class="groupsWithSharingNotAllowed btn-group userGroups" style="white-space:inherit;">
            <div data-tvid='all' data-tid='${traitValues[0].trait.id}'
                ...
                value="all"
                style="padding: 0px; height: 36px; border-radius: 6px; margin:5px;width:${showDetails?'auto':'165px;'} max-width:${showDetails?'auto':'165px;'}; line-height:36px;text-align: left;">
                <img
