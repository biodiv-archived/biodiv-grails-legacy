...
speciesPortal {
    ...
    app.notifiers_bcc = ["prabha.prabhakar@gmail.com", "thomas.vee@gmail.com", "rohitmg@gmail.com","projectwikwio@gmail.com","pascal.marnotte@cirad.fr","thomas.le_bourgeois@cirad.fr"]
    ...
    fields  {
        ...
        IBP_TAXONOMIC_HIERARCHY = "WIKWIO Taxonomy Hierarchy"
    ...
    pamba {
        ...
        speciesPortal {
            ...
            resources {
                ...
                filesutraURL = "https://fileops.${servername}"
            }
