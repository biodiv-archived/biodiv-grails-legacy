...
// internal constants
    ...
    _video = {
        youtube: {
            ...
            reg: /https?:\/\/(?:[0-9A-Z-]+\.)?(?:www\.)?(?:youtu\.be\/|youtube\.com\S*[^\w\-\s])(([\w\-]{11})(?=[^\w\-]|$)(?![?=&+%\w]*(?:['"][^<>]*>|<\/a>))[?=&+%\w-]*)/i,
            //reg: /https?:\/\/(?:[0-9a-zA_Z]{2,3}.)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/watch\?)((?:[\w\d\-\_\=]+&amp;(?:amp;)?)*v(?:&lt;[A-Z]+&gt;)?=([0-9a-zA-Z\-\_]+))/i,
            reg: /https?:\/\/(?:[a-zA_Z]{2,3}.)?(?:youtube\.com\/watch\?)((?:[\w\d\-\_\=]+&amp;(?:amp;)?)*v(?:&lt;[A-Z]+&gt;)?=([0-9a-zA-Z\-\_]+))/i,
            embed: function() {
                return 'http://www.youtube.com/embed/' + this.id;
            },
            getUrl: function() {
                return 'https://www.googleapis.com/youtube/v3/videos?id=' + this.id + '?part=contentDetails&key=AIzaSyAyhfqwsO200BkWr3nH8Zbn8NteoxNhe0o&callback=?';
            },
