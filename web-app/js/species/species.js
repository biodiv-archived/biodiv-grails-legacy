...
(function ($) {
    ...
    AbstractType.prototype = {
        ...
        initEditables : function(selector) {
            this.$element.find(".dummy"+selector).before("<a class='addFieldButton btn btn-success' title='Add'><i class='icon-plus'></i>Add</a>");
            ...
            this.$element.find('.addFieldButton').click(this.onAdd);
            this.$element.find('.editFieldButton').click(this.onEdit);
            this.$element.find('.deleteFieldButton').click(this.onDelete);
        },
